...
Revision ID: d0d1d3af4909
Revises: 
Create Date: 2026-05-19 17:08:07.598682
...
def upgrade() -> None:
    ...
    sa.Column('entity_type', sa.Enum('event', 'incident', name='auditentitytype'), nullable=False),
